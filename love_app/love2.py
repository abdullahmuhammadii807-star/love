...
def get_puzzle_pieces():
    img_path = os.path.join(BASE_DIR, "puzzle_picture.jpg")
    try:
...
# ---------------------------------------------------------
# PHASE 0: THE CREATIVE LOGIN GATEWAY
# ---------------------------------------------------------
...
# ---------------------------------------------------------
# PHASE 3: BIRTHDATE VERIFICATION
# ---------------------------------------------------------
...
# ---------------------------------------------------------
    ...
    hacker_img_path = os.path.join(BASE_DIR, "hacker.jpg")
    try:
        st.image(hacker_img_path, width=400)
    except:
...
# ---------------------------------------------------------
# PHASE 5: THE FINAL CELEBRATION REWARD (ONLY VIDEO 1 PLAYS)
# ---------------------------------------------------------
    ...
    # ALWAYS PLAY VIDEO 1 (Regardless of date entered)
    v1_path = os.path.join(BASE_DIR, "video_1.mp4")
    try:
        st.video(v1_path)
